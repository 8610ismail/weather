...
const API = "253193b4371c37fcfc428af56d2045a5"; // Replace with your actual OpenWeatherMap API key
...
btnEl.addEventListener("click", (e) => {
  ...
  if (inputEl.value !== "") {
    ...
    inputEl.value = ""; // clear input field after search
    findLocation(searchLocation); // call findLocation with the input value
  } else {
    console.log("Please enter a city or country name.");
  }
});

// function to find location and fetch weather data
async function findLocation(name) {
  iconsContainer.innerHTML = ""; // clear previous icons
  dayInfoEl.innerHTML = ""; // clear previous day info
  listContentEl.innerHTML = ""; // clear forecast list
  try {
...
// function to display right side content with weather details
...
async function displayForeCast(lat, lon) {
  ...
  // filter forecast for the next 4 days
...
// function to generate forecast list item
